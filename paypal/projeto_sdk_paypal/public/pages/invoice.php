...
<table class="table table-striped">
    ...
    <?php foreach($invoices as $invoice): ?>
        <tr>
            ...
            <td><?php echo statusInvoice($invoice->status); ?></td>
...
<div class="col-xs-6">
    <input type="text" name="email" id="email" value="cursos@asolucoesweb.com.br" class="form-control" placeholder="Email para enviar a cobrança">
</div>

<div class="col-xs-6">
    <input type="text" name="valor" id="valor" value="665" class="form-control" placeholder="Valor da cobrança">
</div>
